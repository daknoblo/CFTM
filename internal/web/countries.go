...
// countryNames maps ISO 3166-1 alpha-2 codes onto English short names. The
// standard library carries no such table and pulling in a dependency for a
// static list would be worse than keeping it here.
...
// CountryName resolves an ISO code to a readable name, falling back to the raw
// code so an unlisted or newly assigned one still renders.
